...
public class Network extends Thread {
  ...
  private static Semaphore outBuffE;
  private static Semaphore outBuffF;
  private static Semaphore inBuffE;
  private static Semaphore inBuffF;
  private static Semaphore mutexO;
  private static Semaphore mutexI;
//    
    /** 
...
//
       outBuffE = new Semaphore(maxNbPackets);
       outBuffF = new Semaphore(0);
       inBuffE = new Semaphore(maxNbPackets);
       inBuffF = new Semaphore(0);
       mutexO = new Semaphore(1);
       mutexI = new Semaphore(1);
      }     
...
//    
    ...
    public void run()
    {
        ...
        while (true) {
            if (getClientConnectionStatus() == "disconnected"
                    && getServerConnectionStatus() == "disconnected") {
